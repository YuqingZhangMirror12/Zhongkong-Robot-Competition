...
train_generator = train_datagen.flow_from_directory(directory='F:/OpenCVLearn/zhongkong/train',
                                  target_size=(299,299),#Inception V3规定大小
                                  batch_size=8)
val_generator = val_datagen.flow_from_directory(directory='F:/OpenCVLearn/zhongkong/validation',
                                target_size=(299,299),
                                batch_size=8)
# 构建基础模型
